...
//     const sortValue = updates.sort !== undefined ? updates.sort : activeSort;
...
// function normalizeCategory(value: string | undefined): ProductCategory | "all" {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      <Container className="py-8 md:py-12">
        {/* Header with filters - compact and clean */}
