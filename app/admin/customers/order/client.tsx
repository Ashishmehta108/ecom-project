// app/(admin)/pos-order/client.tsx
"use client";
...
import {
  ...
  savePosCustomerDetailsAction,
} from "@/lib/customers/order/actions";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Card } from "@/components/ui/card";
import { ShoppingCart, Plus, Minus, Trash2 } from "lucide-react";
import CustomerDetailsForm from "@/components/admin/Customer";
...
export function AdminCustomerOrderClient({
  ...
  const handleAddToCart = (productId: string) => {
    startTransition(async () => {
      const data = await addToCustomerCartAction(customerId, productId);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <CustomerDetailsForm
        ...
        onSubmit={async (data) =>
          savePosCustomerDetailsAction(customerId, data)
        }
      />
