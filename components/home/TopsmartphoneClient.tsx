        ...
        <div className="flex gap-3 md:gap-4 lg:gap-5 overflow-x-auto snap-x snap-mandatory hide-scrollbar pb-2">
          {resolvedSmartphones.map((p) => {
            ...
            return (
              ...
              >
                {/* IMAGE CONTAINER */}
                <div className="relative w-full aspect-square p-2 md:p-3 rounded-[16px] md:rounded-[20px] dark:bg-neutral-950 flex items-center justify-center">
                  <Image
                    src={p.image}
                    alt={p.name}
                    fill
                ...
                <div className="px-2.5 md:px-3 pt-2 md:pt-3 pb-3 md:pb-4">
                  ...
                  <div className="flex items-center gap-1.5 md:gap-2 mt-1">
                    {/* FINAL PRICE */}
                    <span className="text-sm md:text-[15px] font-bold text-neutral-900 dark:text-neutral-50">
