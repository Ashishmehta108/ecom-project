...
export default function PaymentDonut({ analytics }: { analytics: AdminAnalytics }) {
  ...
  const successRate = total > 0 ? ((kpis.paymentSuccessCount / (total + pending)) * 100).toFixed(1) : "0.0";
